...
function AddButton({ buttonName, info, setInfo, setInfoLength, form }) {
    ...
    return (
        <button className=' mt-4 border px-4 py-2 bg-blue-500 text-slate-50 rounded-xl' onClick={handleAddComponent}>
            {buttonName}
        </button>
    )
}
...
function DeleteButton({ buttonName, info, setInfo, setInfoLength }) {
    ...
    return (
        <button className='mt-4 border px-6 py-2 text-slate-50 bg-red-500 rounded-xl' onClick={handleDeletion} >
            {buttonName}
        </button>
    )
}
...
function DownloadButton() {
    ...
    return (
        <button className='create-button  flex gap-2 mt-4 border px-4 py-2 mx-2 bg-blue-500 text-slate-50 rounded-xl hover:scale-110' onClick={handleDownload}>
