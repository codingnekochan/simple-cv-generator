...
export default function UserCVTemplate({ userBasicInfo, workHistory, educationHistory, skills, certification }) {
    return (
        <section id='resume' className="rounded-sm border bg-white w-[695px]  h-[942px] relative font-[Lato] text-xs pb-4">
            ...
            {/* contact section */}
            <section id='contact' className='w-[220px] h-full bg-[#d9e6ec] absolute top-0 left-8 flex flex-col gap-12  text-[#625f5f]'>
                ...
                {/* skills section */}
                <section id="skill-list" className='pl-4'>
                ...
                <section id="awards-list" className='pl-4'>
